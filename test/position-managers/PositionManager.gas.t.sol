...
contract PosMGasTest is Test, PosmTestSetup, GasSnapshot {
    ...
    function test_gas_mint_withClose() public {
        ...
        TestUtils.snapLastCall("PositionManager_mint_withClose");
    }
    ...
    function test_gas_mint_withSettlePair() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_withSettlePair");
    }
    ...
    function test_gas_mint_differentRanges() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_warmedPool_differentRange");
    }
    ...
    function test_gas_mint_sameTickLower() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_onSameTickLower");
    }
    ...
    function test_gas_mint_sameTickUpper() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_onSameTickUpper");
    }
    ...
    function test_gas_increaseLiquidity_erc20_withClose() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increaseLiquidity_erc20_withClose");
    }
    ...
    function test_gas_increaseLiquidity_erc20_withSettlePair() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithSettlePair(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increaseLiquidity_erc20_withSettlePair");
    }
    ...
    function test_gas_autocompound_exactUnclaimedFees() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increase_autocompoundExactUnclaimedFees");
    }
    ...
    function test_gas_autocompound_clearExcess() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increase_autocompound_clearExcess");
    }
    ...
    function test_gas_autocompound_excessFeesCredit() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increase_autocompoundExcessFeesCredit");
    }
    ...
    function test_gas_decreaseLiquidity_withClose() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decreaseLiquidity_withClose");
    }
    ...
    function test_gas_decreaseLiquidity_withTakePair() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decreaseLiquidity_withTakePair");
    }
    ...
    function test_gas_multicall_initialize_mint() public {
        ...
        TestUtils.snapLastCall("PositionManager_multicall_initialize_mint");
    }
    ...
    function test_gas_collect_withClose() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_collect_withClose");
    }
    ...
    function test_gas_collect_withTakePair() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithTakePair(config.poolKey, address(this));
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_collect_withTakePair");
    }
    ...
    function test_gas_sameRange_mint() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_sameRange");
    }
    ...
    function test_gas_sameRange_decrease() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decrease_sameRange_allLiquidity");
    }
    ...
    function test_gas_sameRange_collect() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_collect_sameRange");
    }
    ...
    function test_gas_burn_nonEmptyPosition_withClose() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_nonEmpty_withClose");
    }
    ...
    function test_gas_burn_nonEmptyPosition_withTakePair() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_nonEmpty_withTakePair");
    }
    ...
    function test_gas_burnEmpty() public {
        ...
        bytes memory calls = planner.encode();
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_empty");
    }
    ...
    function test_gas_decrease_burnEmpty_batch() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(config.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decrease_burnEmpty");
    }
    ...
    function test_gas_mint_native() public {
        ...
        TestUtils.snapLastCall("PositionManager_mint_native");
    }
    ...
    function test_gas_mint_native_excess_withClose() public {
        ...
        TestUtils.snapLastCall("PositionManager_mint_nativeWithSweep_withClose");
    }
    ...
    function test_gas_mint_native_excess_withSettlePair() public {
        ...
        // overpay on the native token
        lpm.modifyLiquidities{value: amount0 * 2}(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_nativeWithSweep_withSettlePair");
    }
    ...
    function test_gas_increase_native() public {
        ...
        lpm.modifyLiquidities{value: amount0 + 1}(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_increaseLiquidity_native");
    }
    ...
    function test_gas_decrease_native() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decreaseLiquidity_native");
    }
    ...
    function test_gas_collect_native() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_collect_native");
    }
    ...
    function test_gas_burn_nonEmptyPosition_native_withClose() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_nonEmpty_native_withClose");
    }
    ...
    function test_gas_burn_nonEmptyPosition_native_withTakePair() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_nonEmpty_native_withTakePair");
    }
    ...
    function test_gas_burnEmpty_native() public {
        ...
        bytes memory calls = planner.encode();
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_burn_empty_native");
    }
    ...
    function test_gas_decrease_burnEmpty_batch_native() public {
        ...
        bytes memory calls = planner.finalizeModifyLiquidityWithClose(configNative.poolKey);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decrease_burnEmpty_native");
    }
    ...
    function test_gas_permit() public {
        ...
        TestUtils.snapLastCall("PositionManager_permit");
    }
    ...
    function test_gas_permit_secondPosition() public {
        ...
        vm.prank(bob);
        lpm.permit(bob, tokenIdAlice, block.timestamp + 1, nonce, signature);
        TestUtils.snapLastCall("PositionManager_permit_secondPosition");
    }
    ...
    function test_gas_permit_twice() public {
        ...
        TestUtils.snapLastCall("PositionManager_permit_twice");
    }
    ...
    function test_gas_mint_settleWithBalance_sweep() public {
        ...
        vm.prank(alice);
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_mint_settleWithBalance_sweep");
    }
    ...
    function test_gas_decrease_take_take() public {
        ...
        lpm.modifyLiquidities(calls, _deadline);
        TestUtils.snapLastCall("PositionManager_decrease_take_take");
    }
    ...
    function test_gas_subscribe_unsubscribe() public {
        ...
        TestUtils.snapLastCall("PositionManager_subscribe");

        lpm.unsubscribe(tokenId);
        TestUtils.snapLastCall("PositionManager_unsubscribe");
    }
}
